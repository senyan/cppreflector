...
class Inflector
{
  ...
  private:
   ...
   string singularize(string word) {
     for(int i = Inflector::singularize_rule_size - 1; i >= 0; i --)
     {
       pcrecpp::RE re(singularize_pattern_replacement[i].first);
       if(re.Replace(singularize_pattern_replacement[i].second, &word)){
...
int main(){
  Inflector inflector;
  cout << inflector.singularize("books")<<endl;
  cout << inflector.singularize("misses")<<endl;
  cout << inflector.singularize("goose")<<endl;
  cout << inflector.singularize("deer")<<endl;
  cout << inflector.singularize("workers")<<endl;
/*
  cout << "books" << " " << inflector.singularize("books")<<endl;
  cout << "man" << " " << inflector.singularize("man")<<endl;
  cout << "goose" << " " << inflector.singularize("goose")<<endl;
  cout << "deer" << " " << inflector.singularize("deer")<<endl;
  cout << "kisses" << " " << inflector.singularize("kisses")<<endl;
  cout << "workers" << " " << inflector.singularize("workers")<<endl;
  cout << "compensations" << " " <<  inflector.singularize("compensations")<<endl;
  cout << "nucleus" << " " << inflector.singularize("nucleus")<<endl;
  cout << "news" << " " << inflector.singularize("news")<<endl;
*/
  exit(1);
}
